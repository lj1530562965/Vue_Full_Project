<template>
  <div class="sidebar">
    <nav class="sidebar-nav">
      <ul class="nav">
        <li class="nav-item">
          <router-link :to="'/orderinquiry'" class="nav-link"><i class="icon-speedometer"></i> 下单/询价 </router-link>
        </li>
        <li class="nav-item">
          <router-link :to="'/historyorder'" class="nav-link"><i class="icon-speedometer"></i> 历史订单 </router-link>
        </li>
        <li class="nav-item">
          <router-link :to="'/salesanalysis'" class="nav-link"><i class="icon-speedometer"></i> 销售分析 </router-link>
        </li>
        <li class="nav-item">
          <router-link :to="'/storemap'" class="nav-link"><i class="icon-speedometer"></i> 门店业绩地图 </router-link>
        </li>
        <li class="nav-item">
          <router-link :to="'/personnelmana'" class="nav-link"><i class="icon-speedometer"></i> 人员管理 </router-link>
        </li>
        <li class="nav-item">
          <router-link :to="'/settings'" class="nav-link"><i class="icon-speedometer"></i> 设置 </router-link>
        </li>
        <li class="nav-item">
